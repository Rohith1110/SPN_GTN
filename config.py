...
# GNN hidden sizes
gatv2_subparser.add_argument('--GNN-hidden-sizes', type=int, nargs='+', default=(1024, 1024),
...
gatv2_subparser.add_argument('--GNN-activation', type=str, choices=activations, default='ELU',
                             help='Activation function to use for GATv2Conv layers.')

# Skip connections strategy
gatv2_subparser.add_argument('--skip-connections', type=str, default='linear',
                             choices=('none', 'identity', 'linear'),
                             help='Type of skip connections. '
                                  'Identity: y = x + conv(x). '
                                  'Linear: y = lin(x) + conv(x).')

# Whether to perform normalization, activation, and dropout before convolution
gatv2_subparser.add_argument('--norm-act-drop-before-conv', action='store_true',
                             help='Perform normalization, activation, and dropout before graph convolution.')
